...
╰〢mengirim pesan siaran secara otomatis
...
async def _(client, message):
    if message.reply_to_message:
        ...
        if len(message.command) < 3:
            return await message.reply("biasa begonya...")
